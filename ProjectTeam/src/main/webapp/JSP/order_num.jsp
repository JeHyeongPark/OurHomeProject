...
<link href="../css/order_num.css" rel="stylesheet">
</head>
<body>
	<div class="order_num_leftbar">
		<ul class="nav">
			<li>회원가입</li>
			<li>회원로그인</li>
			<li>게시판</li>
	...
	<form name="searchdays" id="searchdays" action="orderlist.php"
		...
		<div class="xans-element- xans-myshop xans-myshop-orderhistoryhead ">
			<fieldset class="order_num_ec-base-box">
	...
	<div class="order_num_typeList">
		...
		<table border="1" summary="">
			...
			<tbody class="center ">
				...
				<td style="line-height: 0"><img src="../img/2.jpg"width="300" height="240" alt="#" /></td>
					<td class="product left top">마름모 러그<strong class="name"><a
