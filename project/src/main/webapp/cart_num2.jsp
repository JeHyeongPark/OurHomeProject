...
<!-- 부트스트랩 -->
<link href="../css/bootstrap.min.css" rtext-align:
	center;el="stylesheet">
<style>
@font-face {
...
<body>
	...
	<div class="xans-element- xans-order xans-order-basketpackage ">
		<div
			...
			<p class="right displaynone">
				<b>장바구니에 담긴 상품은 7일 동안 보관됩니다.</b>
			</p>
			<p class="right displaynone">일반상품</p>
		...
		<div
			...
			<table border="1" summary="">
				...
				<tfoot class="right">
					...
					<tr>
						<td colspan="9"><span class="">[기본배송]</span> 상품구매금액 <strong>18,000원
								...
								<span class="displaynone"></span>
						</span> + 배송비 0 <span class="displaynone"></span><span
							class="displaynone"> - 상품할인금액 0 </span> = 합계 : <strong
							class="txtEm"><span class="txt18">18,000원</span></strong><span
				...
				<tbody class="center"
					...
					<tr class="xans-record-">
						...
						<td><span class=""> <span class="ec-base-qty">
									...
									onclick="javascript:changeea_not('down',this);"><img
										src="https://cdn-jull.bizhost.kr/jullweb2019021a8/skin/base/common/btn_quantity_down.gif"
					...
					--> <a href="#none" onclick="addwish('7199613');" class="btnNormal">관심상품등록</a>
							<a href="#none" class="btnNormal select_del" data-index="7199613"
							data-gname="킨시프 벨벳퍼프골지맨투맨" data-account="78000" data-category='티'
							data-index_no="12286"><i class="icoDelete"></i> 삭제</a>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<strong>
			<div
				...
				<span class="gLeft"> <strong class="text"></strong> <a
					href="#none" class="btnEm" onclick="del_chk_jull();"><i
						class="icoDelete"></i> 삭제하기</a> <span class="gRight"> <a
						href="#none" class="btnNormal" onclick="del_all_jull();">장바구니비우기</a>
				</span>
				</span>
		...
		<table border="1" summary="">
			...
			<thead>
				...
				<tr>
					...
					<th scope="col" class="displaynone"><strong>총 할인금액</strong></th>
